...
from admission.contrib.enums import (
    ...
    TypeItemFormulaire, ChoixStatutPropositionContinue,
)
...
class ContinuingDocumentsFormViewTestCase(BaseDocumentsFormViewTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.confirm_url = resolve_url('admission:continuing-education:update:confirm-documents', pk=cls.proposition.uuid)
