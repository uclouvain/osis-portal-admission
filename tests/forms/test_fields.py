...
from admission.contrib.forms.fields import ConfigurableFormMixin, PlainTextWidget
...
class ConfigurableFormItemFieldTestCase(TestCase):
    ...
    def test_configurable_form_compress_method(self):
    ...
    def test_displayed_form(self):
        ...
        self.assertIn('data-values="file:token"', form_p)
