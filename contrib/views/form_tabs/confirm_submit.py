...
__all__ = [
    ...
    'GeneralAdmissionConfirmFormView',
    'ContinuingAdmissionConfirmFormView',
]
...
class GeneralAdmissionConfirmFormView(
    LoadGeneralEducationDossierViewMixin,
    WebServiceFormMixin,
    FormView,
):  # pylint: disable=too-many-ancestors
    ...
    def get_context_data(self, **kwargs):
        ...
        # Retrieve the missing confirmation conditions
        proposition_completion_errors = AdmissionPropositionService.verify_general_proposition(
            person=self.person,
            uuid=self.admission_uuid,
        )
        ...
        if proposition_completion_errors:
            ...
            proposition_completion_errors_by_tab = {
                tab: {'name': get_subtab_label(tab, 'general-education'), 'errors': []}
                for tab in [
                    'person',
                    'coordonnees',
                    'education',
    ...
    def get_success_url(self):
        messages.info(self.request, _("Your proposition has been confirmed."))
        return resolve_url('admission:general-education', pk=self.admission_uuid)
...
class ContinuingAdmissionConfirmFormView(
    LoadContinuingEducationDossierViewMixin,
    WebServiceFormMixin,
    FormView,
):  # pylint: disable=too-many-ancestors
    ...
    def get_context_data(self, **kwargs):
        ...
        # Retrieve the missing confirmation conditions
        proposition_completion_errors = AdmissionPropositionService.verify_continuing_proposition(
            person=self.person,
            uuid=self.admission_uuid,
        )
        ...
        if proposition_completion_errors:
            ...
            proposition_completion_errors_by_tab = {
                tab: {'name': get_subtab_label(tab, 'continuing-education'), 'errors': []}
                for tab in [
                    'person',
                    'coordonnees',
                    'education',
    ...
    def get_success_url(self):
        messages.info(self.request, _("Your proposition has been confirmed."))
        return resolve_url('admission:continuing-education', pk=self.admission_uuid)
