...
from admission.contrib.views.common.detail_tabs.accounting import AdmissionAccountingDetailView
from admission.contrib.views.common.detail_tabs.coordonnees import AdmissionCoordonneesDetailView
from admission.contrib.views.common.detail_tabs.curriculum import AdmissionCurriculumDetailView
from admission.contrib.views.common.detail_tabs.languages import AdmissionLanguagesDetailView
from admission.contrib.views.common.detail_tabs.person import AdmissionPersonDetailView
from admission.contrib.views.common.detail_tabs.training_choice import TrainingChoiceDetailView
from admission.contrib.views.doctorate.project import DoctorateAdmissionProjectDetailView
from admission.contrib.views.doctorate.supervision import DoctorateAdmissionSupervisionDetailView
from admission.contrib.views.doctorate.cotutelle import DoctorateAdmissionCotutelleDetailView
...
# urlpatterns = file_router('admission/contrib/views_gestion_doctorat')
...
urlpatterns = [
    ...
    path('autocomplete/', include(doctorate_patterns)),
